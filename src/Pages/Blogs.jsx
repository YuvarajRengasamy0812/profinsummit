          ...
          <div className="row align-items-center g-5 py-10">
            ...
            <div className="col-lg-6">
              ...
              <h1 className="display-5 fw-bold black mb-3">
                Web3 Wisdom from the <span className="pink">Frontlines</span>
              </h1>
              <p className="text-grey fs-5 mb-4">
                Insider takes on India's blockchain pivot – tutorials, news, and
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-card p-4 rounded-4 shadow-sm">
                ...
                <h4 className="fw-bold black mb-2">
                  5 Crypto Tax Strategies for Indian Traders in 2026
                </h4>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-card p-4 rounded-4 shadow-sm">
                ...
                <h4 className="fw-bold black mb-2">
                  15 Indian Web3 Startups Pitching at Our Summit
                </h4>
