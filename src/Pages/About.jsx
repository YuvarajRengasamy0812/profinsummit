                  ...
                  <div className="row align-items-center">
                    <div className="col-lg-6 col-md-6 px-2 pt-2">
                      <div className="event-benefit-list-left mb-4">
                        <div className="benefit-card py-5 px-4 rounded mb-4 box-shadow bg-white text-center hover-animate">
                          ...
                          <h5 className="mb-2 black">Blockchain Networking</h5>
                          <p className="mb-3 text-grey">
                            Connect with 5,000+ innovators, startups, and
                            investors.
                          </p>
                          <Link
                            to="/Eventlists"
                        ...
                        <div className="benefit-card py-5 px-4 rounded box-shadow bg-white text-center hover-animate">
                          ...
                          <p className="mb-3 text-grey">
                            Explore international blockchain trends and
                    ...
                    <div className="col-lg-6 col-md-6 px-2">
                      <div className="benefit-card py-5 px-4 rounded box-shadow bg-white text-center hover-animate">
                        ...
                        <h5 className="mb-2 black">DeFi & Tokens</h5>
                        <p className="mb-3 text-grey">
                          Hands-on sessions on NFTs, DeFi, and digital assets
                          scaling.
                        </p>
                        <Link
                          to="/Eventlists"
                ...
                <div className="event-benefit-list-right text-lg-start ps-lg-5">
                  <div className="overview-title pb-4">
                    ...
                    <h2 className="mb-3 black fw-bold">
                      Discover the <span className="pink">Blockchain Edge</span>
                    </h2>
                  </div>
                  <div className="overview-info text-grey">
                    <p>
                      Immerse in India's Web3 revolution: DeFi, NFTs, digital
                      assets, and regulatory insights. Learn from industry
                      leaders, connect with top innovators, and gain hands-on
                      experience at workshops and labs.
                    </p>
                    <p>
                      Join 100+ speakers, 50+ sessions, and 5,000+ attendees to
                      scale your knowledge and network in the heart of India’s
