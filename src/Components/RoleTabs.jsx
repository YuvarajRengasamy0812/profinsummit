          ...
          {activeTab === "visitor" && (
            <div>
              ...
              <ul className="text-grey">
                <li>Trendspot: 50+ sessions on hot topics like zk-proofs.</li>
                <li>Network: App-matched intros to 5,000 pros.</li>
                <li>Perks: Free swag, certifications — Visitor Pass from ₹1,999.</li>
              </ul>

              <a href="/pricing" className="btn bg-blue text-white px-4 py-2 mt-3 rounded-pill">
                Get Visitor Pass
              </a>
            </div>
          )}
          ...
          {activeTab === "exhibitor" && (
            <div>
              ...
              <ul className="text-grey">
                ...
                <li>Setup done in 2 hours with our team.</li>
              </ul>
        ...
        >
          ...
          {activeTab === "speaker" && (
            <div>
              ...
              <ul className="text-grey">
                <li>Share your Web3 story on the big stage.</li>
                <li>Full promo, travel & VIP access managed for you.</li>
                <li>Topics include DeFi ethics, AI-blockchain fusion.</li>
              </ul>
