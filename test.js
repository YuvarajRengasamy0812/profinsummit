                                        ...
                                        <div key={i} className="col-lg-6 col-md-6">
                                            <div className="blog-box border border-1 rounded pb-2 text-center">
                                                ...
                                                <div className="blog-info p-4">
                                                    <h5 className="mb-2"><Link to="/Blogsingle" className="black">{blogs.title} </Link></h5>
                                                    <p className="mb-2">
                                                       {subheading}
                                                    </p>
                                                ...
                                                <div className="pt-2 blog-data mt-auto border-top">
                                                    <span className="px-4  border-end "><small>{blogs.date} </small></span><span className="px-4"><small>No Comments</small> </span>
                                                </div>
                                            </div>
                                        </div>
  );
